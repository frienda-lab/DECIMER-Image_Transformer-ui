...
try:
    visible_deprecation_warning = np.VisibleDeprecationWarning
except AttributeError:  # NumPy 2.x
    from numpy.exceptions import VisibleDeprecationWarning as visible_deprecation_warning
...
def _detect_hough_lines(
    ...
    for line in lines:
        # OpenCV 4 returns (N, 1, 4), while OpenCV 5 may return
        # (N, 4). Flattening supports both layouts.
